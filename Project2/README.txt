...
The project includes four class(Parser, Printer, Scanner, Evaluator)and a Struct(TreeNode).
...
Evaluator includes one main function: eval. It will evaluate the Sexpression one by one. 
